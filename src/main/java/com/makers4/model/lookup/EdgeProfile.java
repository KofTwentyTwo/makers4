...
@Entity
@Table(name = EdgeProfile.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = EdgeProfile.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "drawerFrontEdgeProfileId",
...
public class EdgeProfile extends QRecordEntity
{
   public static final String TABLE_NAME  = "edge_profile";
   public static final String TABLE_LABEL = "Edge Profiles";
   public static final String ICON_NAME   = "rounded_corner";
   ...
   public EdgeProfile withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public EdgeProfile withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public EdgeProfile withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public EdgeProfile withDescription(String description)
   {
   ...
   public EdgeProfile withSortOrder(Integer sortOrder)
   {
   ...
   public EdgeProfile withIsActive(Boolean isActive)
   {
   ...
   public EdgeProfile withCreateDate(Instant createDate)
   {
   ...
   public EdgeProfile withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(EdgeProfile.TABLE_NAME, Cabinet.TABLE_NAME);
