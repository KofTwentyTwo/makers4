...
@Entity
@Table(name = DoorStyle.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = DoorStyle.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "doorStyleId",
...
public class DoorStyle extends QRecordEntity
{
   public static final String TABLE_NAME  = "door_style";
   public static final String TABLE_LABEL = "Door Styles";
   public static final String ICON_NAME   = "door_sliding";
   ...
   public DoorStyle withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public DoorStyle withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public DoorStyle withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public DoorStyle withDescription(String description)
   {
   ...
   public DoorStyle withSortOrder(Integer sortOrder)
   {
   ...
   public DoorStyle withIsActive(Boolean isActive)
   {
   ...
   public DoorStyle withCreateDate(Instant createDate)
   {
   ...
   public DoorStyle withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(DoorStyle.TABLE_NAME, Cabinet.TABLE_NAME);
