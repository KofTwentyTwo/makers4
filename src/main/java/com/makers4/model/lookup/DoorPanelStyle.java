...
@QMetaDataProducingEntity(produceTableMetaData = true, tableMetaDataCustomizer = DoorPanelStyle.TableMetaDataCustomizer.class, producePossibleValueSource = true)
