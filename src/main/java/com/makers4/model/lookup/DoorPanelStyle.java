...
@Entity
@Table(name = DoorPanelStyle.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = DoorPanelStyle.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "doorPanelStyleId",
...
public class DoorPanelStyle extends QRecordEntity
{
   public static final String TABLE_NAME  = "door_panel_style";
   public static final String TABLE_LABEL = "Door Panel Styles";
   public static final String ICON_NAME   = "dashboard";
   ...
   public DoorPanelStyle withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public DoorPanelStyle withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public DoorPanelStyle withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public DoorPanelStyle withDescription(String description)
   {
   ...
   public DoorPanelStyle withSortOrder(Integer sortOrder)
   {
   ...
   public DoorPanelStyle withIsActive(Boolean isActive)
   {
   ...
   public DoorPanelStyle withCreateDate(Instant createDate)
   {
   ...
   public DoorPanelStyle withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(DoorPanelStyle.TABLE_NAME, Cabinet.TABLE_NAME);
