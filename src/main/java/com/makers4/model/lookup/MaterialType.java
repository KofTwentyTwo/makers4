...
public class MaterialType extends QRecordEntity
{
   ...
   public static final String TABLE_LABEL = "Material Types";
   public static final String ICON_NAME   = "category";
   ...
   public MaterialType withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public MaterialType withSortOrder(Integer sortOrder)
   {
   ...
   public MaterialType withIsActive(Boolean isActive)
   {
   ...
   public MaterialType withCreateDate(Instant createDate)
   {
   ...
   public MaterialType withModifyDate(Instant modifyDate)
   {
