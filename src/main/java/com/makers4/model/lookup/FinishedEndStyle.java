...
@Entity
@Table(name = FinishedEndStyle.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = FinishedEndStyle.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "finishedEndStyleId",
...
public class FinishedEndStyle extends QRecordEntity
{
   public static final String TABLE_NAME  = "finished_end_style";
   public static final String TABLE_LABEL = "Finished End Styles";
   public static final String ICON_NAME   = "flip";
   ...
   public FinishedEndStyle withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public FinishedEndStyle withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public FinishedEndStyle withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public FinishedEndStyle withDescription(String description)
   {
   ...
   public FinishedEndStyle withSortOrder(Integer sortOrder)
   {
   ...
   public FinishedEndStyle withIsActive(Boolean isActive)
   {
   ...
   public FinishedEndStyle withCreateDate(Instant createDate)
   {
   ...
   public FinishedEndStyle withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(FinishedEndStyle.TABLE_NAME, Cabinet.TABLE_NAME);
