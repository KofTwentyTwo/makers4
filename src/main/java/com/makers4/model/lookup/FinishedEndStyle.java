...
@QMetaDataProducingEntity(produceTableMetaData = true, tableMetaDataCustomizer = FinishedEndStyle.TableMetaDataCustomizer.class, producePossibleValueSource = true)
