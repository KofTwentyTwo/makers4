...
public class DrawerFrontStyle extends QRecordEntity
{
   ...
   public static final String TABLE_LABEL = "Drawer Front Styles";
   public static final String ICON_NAME   = "drag_indicator";
   ...
   public DrawerFrontStyle withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public DrawerFrontStyle withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public DrawerFrontStyle withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public DrawerFrontStyle withDescription(String description)
   {
   ...
   public DrawerFrontStyle withSortOrder(Integer sortOrder)
   {
   ...
   public DrawerFrontStyle withIsActive(Boolean isActive)
   {
   ...
   public DrawerFrontStyle withCreateDate(Instant createDate)
   {
   ...
   public DrawerFrontStyle withModifyDate(Instant modifyDate)
   {
