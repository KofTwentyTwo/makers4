...
@Entity
@Table(name = FaceType.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = FaceType.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "faceTypeId",
...
public class FaceType extends QRecordEntity
{
   public static final String TABLE_NAME  = "face_type";
   public static final String TABLE_LABEL = "Face Types";
   public static final String ICON_NAME   = "view_quilt";
   ...
   public FaceType withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public FaceType withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public FaceType withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public FaceType withDescription(String description)
   {
   ...
   public FaceType withSortOrder(Integer sortOrder)
   {
   ...
   public FaceType withIsActive(Boolean isActive)
   {
   ...
   public FaceType withCreateDate(Instant createDate)
   {
   ...
   public FaceType withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(FaceType.TABLE_NAME, Cabinet.TABLE_NAME);
