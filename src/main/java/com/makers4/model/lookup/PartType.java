...
@Entity
@Table(name = PartType.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = PartType.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "partTypeId",
...
public class PartType extends QRecordEntity
{
   public static final String TABLE_NAME  = "part_type";
   public static final String TABLE_LABEL = "Part Types";
   ...
   @QField(maxLength = 60, backendName = "category")
   ...
   public PartType withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public PartType withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public PartType withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public PartType withDescription(String description)
   {
   ...
   public PartType withCategory(String category)
   {
   ...
   public PartType withSortOrder(Integer sortOrder)
   {
   ...
   public PartType withIsActive(Boolean isActive)
   {
   ...
   public PartType withCreateDate(Instant createDate)
   {
   ...
   public PartType withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         table.addSection(new QFieldSection("identity", "Identity", new QIcon(ICON_NAME), Tier.T1, List.of("id", "code", "name", "description", "category")));
         table.addSection(new QFieldSection("settings", "Settings", new QIcon("settings"), Tier.T2, List.of("sortOrder", "isActive")));

         ////////////////////////////////
         // Child Parts Section //
         ////////////////////////////////
         String partsJoinName = QJoinMetaData.makeInferredJoinName(PartType.TABLE_NAME, Part.TABLE_NAME);
