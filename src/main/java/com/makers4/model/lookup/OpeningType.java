...
public class OpeningType extends QRecordEntity
{
   ...
   public static final String TABLE_LABEL = "Opening Types";
   ...
   public OpeningType withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public OpeningType withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public OpeningType withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public OpeningType withDescription(String description)
   {
   ...
   public OpeningType withSortOrder(Integer sortOrder)
   {
   ...
   public OpeningType withIsActive(Boolean isActive)
   {
   ...
   public OpeningType withCreateDate(Instant createDate)
   {
   ...
   public OpeningType withModifyDate(Instant modifyDate)
   {
