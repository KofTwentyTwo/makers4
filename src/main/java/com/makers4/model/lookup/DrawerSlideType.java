...
@QMetaDataProducingEntity(produceTableMetaData = true, tableMetaDataCustomizer = DrawerSlideType.TableMetaDataCustomizer.class, producePossibleValueSource = true)
