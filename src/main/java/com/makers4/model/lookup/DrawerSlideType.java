...
@Entity
@Table(name = DrawerSlideType.TABLE_NAME)
@QMetaDataProducingEntity(
   produceTableMetaData = true,
   tableMetaDataCustomizer = DrawerSlideType.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "drawerSlideTypeId",
...
public class DrawerSlideType extends QRecordEntity
{
   public static final String TABLE_NAME  = "drawer_slide_type";
   public static final String TABLE_LABEL = "Drawer Slide Types";
   public static final String ICON_NAME   = "linear_scale";
   ...
   public DrawerSlideType withId(Long id)
   {
      this.id = id;
      return this;
   }
   ...
   public DrawerSlideType withCode(String code)
   {
      this.code = code;
      return this;
   }
   ...
   public DrawerSlideType withName(String name)
   {
      this.name = name;
      return this;
   }
   ...
   public DrawerSlideType withDescription(String description)
   {
   ...
   public DrawerSlideType withSortOrder(Integer sortOrder)
   {
   ...
   public DrawerSlideType withIsActive(Boolean isActive)
   {
   ...
   public DrawerSlideType withCreateDate(Instant createDate)
   {
   ...
   public DrawerSlideType withModifyDate(Instant modifyDate)
   {
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(DrawerSlideType.TABLE_NAME, Cabinet.TABLE_NAME);
