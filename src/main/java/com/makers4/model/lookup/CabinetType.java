...
@QMetaDataProducingEntity(
   ...
   tableMetaDataCustomizer = CabinetType.TableMetaDataCustomizer.class,
   producePossibleValueSource = true,
   childTables = {
      @ChildTable(
         joinFieldName = "cabinetTypeId",
...
public class CabinetType extends QRecordEntity
{
   ...
   public static class TableMetaDataCustomizer implements MetaDataCustomizerInterface<QTableMetaData>
   {
      ...
      public QTableMetaData customizeMetaData(QInstance qInstance, QTableMetaData table) throws QException
      {
         ...
         ////////////////////////////////
         String cabinetsJoinName = QJoinMetaData.makeInferredJoinName(CabinetType.TABLE_NAME, Cabinet.TABLE_NAME);
