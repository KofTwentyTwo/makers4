...
@QMetaDataProducingEntity(produceTableMetaData = true, tableMetaDataCustomizer = CabinetOpening.TableMetaDataCustomizer.class, producePossibleValueSource = true)
