...
public class BlueprintElements
{
    ...
    *******************************************************************************/
   public void drawTitleBlock(PDPageContentStream cs, String drawingName,
                               ...
                               String label, String value) throws Exception
   {
      ...
      cs.showText(truncateText(value, 14));
      cs.endText();
   }
   ...
   /*******************************************************************************
    ** Calculate the auto-scale factor to fit content in drawing area.
    ** Returns points per inch.
    *******************************************************************************/
   public double calculateAutoScale(double contentWidthInches, double contentHeightInches)
   {
      ...
      double scaleX = usableWidth / contentWidthInches;
      double scaleY = usableHeight / contentHeightInches;
   ...
   /*******************************************************************************
    ** Calculate the offset to center the content in the drawing area.
    *******************************************************************************/
   public double[] calculateCenterOffset(double contentWidthInches,
                                         double contentHeightInches,
                                         double scale)
   {
      Rectangle2D drawingArea = getDrawingArea();

      double scaledWidth  = contentWidthInches * scale;
      double scaledHeight = contentHeightInches * scale;
